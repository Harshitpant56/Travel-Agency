...
export const RIGHT_CONFETTI = {
 ...
 export const user = { name: "Harshit" };

  export const dashboardStats = {
    totalUsers: 12450,
    usersJoinded: { currentMonth: 218, lastMonth: 176 }, // +24%
    totalTrips: 3210,
    tripsCreated: { currentMonth: 150, lastMonth: 250 }, // -40%
    userRole: { total: 62, currentMonth: 25, lastMonth: 15 }, // +67%
  };
